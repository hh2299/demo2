...
public class StringUtil {
     ...
     *
     * @param from nullかどうかの検査対象
     * @param to   fromがnullの場合に返す値
     ...
     *
     * @param inStr    対象文字列
     * @param startPos byte単位の切り出す開始位置 (この値を含む)
     * @param endPos   byte単位の切り出す終了位置 (この値を<b>含まない</b>)
     * @return 切り取った結果の文字列
     * @see String
     */
     ...
     *
     * @param inStr   元の文字列
     * @param byteLen 長さの上限(全角文字を2、半角文字を1とした長さ)
     * @param strPad  追加文字列
     * @return 加工後の文字列
     */
     ...
     *
     * @param pstrString  読み取る文字列
     * @param pstrForNull null時に返す文字列
     * @return 返す文字列
     */
     ...
     * @param pstrOldStr 置換対象の文字列
     * @param pstrNewStr 置換後の文字列
     * @return 置換をかけた数字列
     * @deprecated {@link String#replaceAll(String, String)}
     */
     ...
     *
     * @param value           トリム対象の文字列
     * @param removeBlankLine trueなら文中の空行を削除する。falseなら文中の空行は削除しない。
     * @return トリム後の文字列
     */
     ...
     *
     * @param val       変換する値
     * @param srcFormat 変換元フォーマット。省略(nullに)した場合は"#,##0.###"が適用されます。
     * @param outFormat 変換後のフォーマット。省略(nullに)した場合は変換前のフォーマットが適用されます。
     * @return 変換後の値
     */
     ...
     *
     * @param val          変換対象となる数値
     * @param srcFormat    変換元フォーマット。略(nullに)した場合は"#,##0.###"が適用されます。
     * @param outFormat    変換後のフォーマット。省略(nullに)した場合は変換前のフォーマットが適用されます。
     * @param roundingMode 丸め方法。省略(nullに)した場合は、 {@link RoundingMode#HALF_EVEN} に従います。
     *                     {@link RoundingMode}
     * @return 変換後の値
     */
    ...
    public static void main(String[] aa) {
        // System.out.println(StringEncrypt.Encrypt(StringUtil.encrypt("inheater123")));
        // // 获取Calendar
        // Calendar calendar = Calendar.getInstance();
        // // 设置时间,当前时间不用设置
        // calendar.setTime(DateUtil.parse("2016-08-01 23:59:59", "yyyy-MM-dd
        // HH:mm:ss"));
        // // 设置日期为本月最大日期
        ...
        //
        // DateFormat df1 = new SimpleDateFormat("MMM yyyy",Locale.ENGLISH);
     ...
     * @return
     */
    public static String toThousandString(BigDecimal data) {
        DecimalFormat df = new DecimalFormat("###,##0.00");
        String result = df.format(data);
        return result;
    }

    public static String toThousandStringWithOutDot(BigDecimal data) {
